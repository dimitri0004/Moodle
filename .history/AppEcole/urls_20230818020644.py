...
from .views import index, inscription, connexion,ajouter_projet,deconnexion,liste_projets,modifier
urlpatterns = [
    ...
    path('enseignant/projet/modifier/<int:id>',modifier, name='modifier_projet'),
