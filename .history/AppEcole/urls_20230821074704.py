...
from .views import index, inscription, connexion,ajouter_projet,deconnexion,liste_projets,modifier_projet,supprimer_projet,afficher_profil
urlpatterns = [
    ...
    path('enseignant/profil/modifier/<int:id>',afficher_profil, name='modifier_profile'),
