...
def ajouter_projet(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message="votre projet a été ajouter avec succes" # Rediriger vers la liste des projets
    else:
        form = ProjetForm()
...
def modifier_projet(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('liste_projet')
            message="votre projet a été modifier avec succes" # Rediriger vers la liste des projets
    else:
...
def supprimer_projet(request, id):
    ...
    if request.method == 'POST':
        ...
        message="votre projet a été supprimer avec succes" 
