...
from .views import index, inscription, connexion,ajouter_projet,deconnexion,liste_projets,modifier_projet,supprimer_projet,afficher_profil,modifier_profil
urlpatterns = [
    ...
    path('enseignant/profil/modifier/<int:id>',modifier_projet_profil, name='modifier_profile'),
