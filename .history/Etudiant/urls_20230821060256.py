...
from .views import liste_Projets,ajouter_soumission,liste_soumission,modifier_soumission,supprimer_soumission, afficher_profil
urlpatterns = [
    ...
    path('profil/', modifier_profil, name='profil_modifier'),
