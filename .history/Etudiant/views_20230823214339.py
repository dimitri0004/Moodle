...
def ajouter_soumission(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('liste_soumission')  # Redirect after successful submission
    else:
        form = SoumissionForm()
...
def modifier_soumission(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message="votre soumission a été modifier avec succes"
...
def supprimer_soumission(request, id):
    ...
    if request.method == 'POST':
        ...
        message="votre Soumission a été supprimer avec succes" 
    context = {
...
def modifier_profil(request, id):
    ...
    if request.method == "POST":
        ...
        if not error:
            ...
            user.save()
            return redirect('profil')  # Redirect to user list page after successful update
