...
def ajouter_cour(request):
    ...
    return render(request, 'administrateur/Cour/ajouter.html', context)

def liste_cour(request):
    cours = Cour.objects.all()
    return render(request, 'administrateur/Cour/index.html', {'cours': cours})

def modifier_cour(request, id):
    cour = get_object_or_404(Devoir, id=id)
    messages=""
    if request.method == 'POST':
    ...
    context = {'form': form,
               'message':messages}
    return render(request, 'administrateur/Cour/modifier.html', context)
...
def supprimer_cour(request, id):
    ...
    context = {'intitule': intitule,
               'cour':cour,
               'message':messages}
    return render(request, 'administrateur/Cour/supprimer.html', context)
