...
def register(request):
    ...
    return render(request, 'administrateur/inscription.html', context)   

def liste_utilisateur(request):
    projets = User.objects.all()
    return render(request, 'administrateur/utilisateur.html', {'Projets': projets}) 
